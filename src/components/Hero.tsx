  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/shahabuddin01md',
      label: 'GitHub',
      color: 'hover:text-gray-900',
    },
    {
      icon: <Linkedin className="h-6 w-6" />,
      url: 'https://www.linkedin.com/in/shahabuddin01md/',
      label: 'LinkedIn',
      color: 'hover:text-blue-600',
    },
    {
      icon: <Twitter className="h-6 w-6" />,
      url: 'https://x.com/mr_subbu_af',
      label: 'Twitter (X)',
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Md Shahabuddin</span>
              </h1>
